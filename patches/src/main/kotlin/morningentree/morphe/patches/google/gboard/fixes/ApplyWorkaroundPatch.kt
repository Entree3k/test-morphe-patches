...
/**
 * Removes an Android-15 input-method attribute that current AAPT cannot link, so the patched
 * APK re-compiles. Applies to Gboard 14.1.x and later. Ported from the adobo patches.
 */
